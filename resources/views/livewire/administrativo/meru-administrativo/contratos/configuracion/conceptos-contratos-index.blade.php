            ...
            <div class="table-responsive">
                <x-table-headers class="py-2" :sortby="$sort" :order="$direction" :headers="$headers">
                    @foreach ($opconceptos as $opconceptosItem)
                        <tr>
                            <td align="center" >
                                <a href="{{ route('contratos.configuracion.conceptoscontratos.show', $opconceptosItem->id ) }}" aria-label="Left Align" data-toggle="tooltip" data-placement="left" title="Mostrar">
                                    {{ $opconceptosItem->id }}
                                </a>
                            </td>
                            ...
                            <td align="center" >
                                <a href="{{ route('contratos.configuracion.conceptoscontratos.edit', $opconceptosItem->id) }}" type="button" class="btn-sm" aria-label="Left Align" data-toggle="tooltip" data-placement="left" title="Editar">
