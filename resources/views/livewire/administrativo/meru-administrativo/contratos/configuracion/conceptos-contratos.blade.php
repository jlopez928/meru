		...
		<div class="row col-12">
            ...
            <x-field class="text-center col-2 ">
                ...
                <x-select   name="sta_reg" class="text-center form-control-sm{{ $errors->has('sta_reg') ? 'is-invalid' : '' }}">
                    <option value="{{ old('sta_reg', $conceptoscontratos->sta_reg) == '0' ? '0' : '1' }}" selected>{{ old('sta_reg', $conceptoscontratos->sta_reg) == '0' ? 'INACTIVO' : 'ACTIVO' }}</option>
                    <option value="{{ old('sta_reg', $conceptoscontratos->sta_reg) == '0' ? '1' : '0'}}"> {{ old('sta_reg', $conceptoscontratos->sta_reg) == '0' ? 'ACTIVO' : 'INACTIVO' }}</option>
             </x-select>
                <div class="invalid-feedback">
