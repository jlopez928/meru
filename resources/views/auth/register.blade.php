    ...
    <div class="row justify-content-end">
        <div class="col-md-6">
            <div class="card card-secondary shadow-lg">
                <div class="card-header"><h3><i class="fas fa-address-card mr-2"></i> {{ __('Register') }}</h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-5 col-form-label text-md-right">{{ __('ID number') }}</label>

                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('cedula') }}">
                                <span class="text-muted"><small>Ej. 20547632</small></span>
