<div class="text-center">
    ...
    style="font-size:10px !important;">
        ...
        <select name="ano_pro" id="ano_pro" style="height:auto; line-height:14px; border-radius:0.25rem; color:#495057; background-color:#fff;" onchange="$('#periodo-form').submit();" {{ $periodos->count() == 1 ? 'disabled' : '' }}>
