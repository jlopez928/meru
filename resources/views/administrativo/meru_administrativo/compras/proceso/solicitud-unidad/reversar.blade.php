...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active text-bold">Reversar</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <x-form name="formulario" method="post" action="{{ route('compras.proceso.solicitud_unidad.reversar_solicitud') }}">
