		...
		<div class="row mb-2">
			<div class="col-sm-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Ajustes Presupuestarios</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<x-form method="post" action="{{ route('presupuesto.reporte.ajustes.store') }}" target="_blank">
					<x-card>
						<x-slot name="header">
							<h3 class="card-title text-bold">Ajustes Presupuestarios</h3>
						</x-slot>
						...
						<x-slot name="body">
							...
							<div class="row col-12">
								<div class="form-group col-2 offset-4">
									...
									<x-select name="ano_pro" class="select2bs4 form-control-sm {{ $errors->has('ano_pro') ? 'is-invalid' : '' }} " required>
								...
								<div class="form-group col-2">
									...
									<x-select name="mes" class="select2bs4 form-control-sm {{ $errors->has('mes') ? 'is-invalid' : '' }}" required>
										<option value="">Seleccione...</option>
							...
							<div class="row col-12">
								<div class="form-group col-6 offset-3">
									...
									<x-select name="criterio" class="select2bs4 form-control-sm {{ $errors->has('criterio') ? 'is-invalid' : '' }}">
										<option value="">Seleccione...</option>
