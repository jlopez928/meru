        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active text-bold">Cierre Certificación de Obras y Servicios</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <x-form method="get" action="{{ route('contratos.proceso.certificacioncontrato.cierre_compromiso_certificacion', $opsolservicio->id) }}">
                    <div class="col-12">
                        <x-card>
                            <x-slot name="header">
                            ...
                            <x-slot name="footer">
                                <x-input type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Cierre Presupuestario" />
                            </x-slot>
                        </x-card>
                    </div>
                </x-form>
