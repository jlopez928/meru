        ...
        <div class="row col-12">
            ...
            <x-field class="text-center col-2 ">
                ...
                <x-select   wire:model.defer="tip_contrat" id="tip_contrat"  name="tip_contrat" class="form-control-sm {{ $errors->has('tip_contrat') ? 'is-invalid' : '' }}">
            ...
            <x-field class="text-center col-2 -bottom-3">
                ...
                <x-input  wire:model.defer="num_contrato" id="num_contrato" name="num_contrato"  class="form-control-sm {{ $errors->has('num_contrato') ? 'is-invalid' : '' }}" />
                <div class="invalid-feedback">
