        ...
        <div class="row col-12">
            <x-field class="text-center col-1 offset-2">
                ...
                <x-select style="{{ $habilitar==true ? 'pointer-events: none' : '' }}" wire:model.defer="ano_pro" wire:keydown.enter.prevent="buscar_contrato()"  wire:model.defer="ano_pro" id="ano_pro" name="ano_pro" class="form-control-sm {{ $errors->has('ano_pro') ? 'is-invalid' : '' }}">
            ...
            <x-field class="text-center col-2">
                ...
                <x-input style="{{ $habilitar==true ? 'pointer-events: none' : '' }}"   wire:model.defer="xnro_sol" wire:keydown.enter.prevent="buscar_contrato()" wire:model.defer="xnro_sol"  id="xnro_sol" name="xnro_sol" class="text-center form-control-sm  {{ $errors->has('xnro_sol') ? 'is-invalid' : '' }}" />
                <div class="invalid-feedback">
        ...
        <div class="row col-12">
            ...
            <x-field class="text-center col-6">
                <x-label for="rif_prov">Beneficiario</x-label>
                     <x-select style="pointer-events:none" readonly  wire:model.defer="rif_prov" id="rif_prov" name="rif_prov" class="form-control-sm {{ $errors->has('rif_prov') ? 'is-invalid' : '' }}">
            ...
            <x-field class="text-center col-6">
                <x-label for="lcod_ger">Gerencia</x-label>
                     <x-select style="pointer-events:none" readonly  wire:model.defer="cod_ger" id="cod_ger" name="cod_ger" class="form-control-sm {{ $errors->has('cod_ger') ? 'is-invalid' : '' }}">
        ...
        <div class="row col-12">
            <x-field class="text-center col-2 offset-4">
                ...
                <x-input  style="{{ $nombreRuta =='contrato'||  $habilitar==true ? '' : 'pointer-events: none' }}"   wire:model.defer="pto_cta" id="pto_cta" name="pto_cta" class="form-control-sm {{ $errors->has('pto_cta') ? 'is-invalid' : '' }}" />
                <div class="invalid-feedback">
            ...
            <x-field class="text-center col-2 ">
                <x-label for="lfec_pto">Fecha del Punto</x-label>
                 <x-input  style="{{ $nombreRuta =='contrato'||  $habilitar==true ? '' : 'pointer-events: none' }}"  wire:model.defer="fec_pto" id="fec_pto" name="fec_pto" type="date" class="form-control-sm {{ $errors->has('fec_pto') ? 'is-invalid' : '' }}"/>
                <div class="invalid-feedback">
        ...
        <div class="row col-12">
            <x-field class="text-center col-2 offset-4">
                ...
                <x-input  style="{{ $nombreRuta =='contrato'||  $habilitar==true ? '' : 'pointer-events: none' }}"   wire:model.defer="por_anticipo" wire:keydown.tab.prevent="calcularAnticipo('#identificacion-tab')" x-mask:dynamic="$money($input, ',')" id="por_anticipo" name="por_anticipo"  class="form-control-sm text-right {{ $errors->has('por_anticipo') ? 'is-invalid' : '' }}" />
                    <div class="invalid-feedback">
            ...
            <x-field class="text-center col-2 ">
                ...
                <x-input readonly wire:model.defer="mto_ant" readonly  x-mask:dynamic="$money($input, ',')" id="mto_ant" name="mto_ant"  class="form-control-sm text-right {{ $errors->has('mto_ant') ? 'is-invalid' : '' }}" />
                    <div class="invalid-feedback">
        ...
        <div class="row col-12">
            ...
            <x-field class="text-center col-2 ">
                ...
                <x-select   style="pointer-events:none"   readonly wire:model.defer="tip_contrat" id="tip_contrat"  name="tip_contrat" class="form-control-sm {{ $errors->has('tip_contrat') ? 'is-invalid' : '' }}">
        ...
        <div class="row col-12">
            <x-field class="text-center col-2 offset-2">
                ...
                <x-select  style="pointer-events:none"  readonly  wire:model.defer="tip_pag" id="tip_pag"  name="tip_pag" class="form-control-sm {{ $errors->has('tip_pag') ? 'is-invalid' : '' }}">
            ...
            <x-field class="text-center col-2">
                ...
                <x-select   style="pointer-events:none"  readonly  wire:model.defer="factura" wire:change="limpiar()"  id="factura" name="factura" class="form-control-sm {{ $errors->has('factura') ? 'is-invalid' : '' }}">
            ...
            <x-field class="text-center col-2 ">
                ...
                <x-select  style="{{ $nombreRuta =='contrato'||  $habilitar==true ? '' : 'pointer-events: none' }}"   id="mod" name="mod" wire:model.defer="mod" class="form-control-sm {{ $errors->has('mod') ? 'is-invalid' : '' }}">
