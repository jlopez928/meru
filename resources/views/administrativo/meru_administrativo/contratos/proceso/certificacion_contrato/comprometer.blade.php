...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <x-form method="get" action="{{ route('contratos.proceso.certificacioncontrato.comprometer_certificacion', $opsolservicio->id) }}">
                    <div class="col-12">
                        <x-card>
                            <x-slot name="header">
                                <h3 class="card-title text-bold">Certificación de Obrar y Servicio</h3>
                            </x-slot>
                            <x-slot name="body">
