            ...
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                  @if($nombreRuta =='contrato')
                    ...
                    <li class="breadcrumb-item active text-bold">Anular Certificación de Obrar y Servicio</li>
                  @else
                     ...
                     <li class="breadcrumb-item active text-bold">Anular Certificación de Obrar y Servicio Addendum</li>
                  @endif
                </ol>
            </div>
        </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <x-form method="get" action="{{ route('contratos.proceso.certificacioncontrato.anular_certificacion', $opsolservicio->id) }}">
                    <div class="col-12">
                        <x-card>
                            <x-slot name="header">
                            ...
                            <x-slot name="footer">
                                <x-input type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Anular" />
                            </x-slot>
                        </x-card>
                    </div>
                </x-form>
