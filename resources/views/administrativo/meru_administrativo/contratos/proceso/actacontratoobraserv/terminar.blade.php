		...
		<div class="row mb-2">
			<div class="col-sm-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Terminar Entrega</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
                <x-form method="get" action="{{ route('contratos.proceso.actacontratobraserv.terminarentrega', $encnotaentrega->id) }}">
                    <x-card>
                        <x-slot name="header">
                        ...
                        <x-slot name="body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="acta" role="tabpanel" aria-labelledby="acta-tab">
                                    @include('administrativo/meru_administrativo/contratos/procesos/actacontratoobraserv/partials_show/_actainicio')
                                </div>
                        ...
                        <x-slot name="footer">
                            <x-input id="iniciar" name="terminar" type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Terminar entrega" />
                        </x-slot>
                    </x-card>
                </x-form>
			</div>
