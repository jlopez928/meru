<!-- Divisor Entrega HidroBolívar-->
    ...
    <div class="row col-12 offset-1">
        {{--  <div class="form-group col-1">
            ...
            <x-input name="id" type="hidden" class="form-control-sm text-center " value="{{ $encnotaentrega->id }}" maxlength="5" disabled/>
        {{--  </div>  --}}
        ...
        <div class="form-group col-1">
            ...
            <x-input name="nro_ent" class="form-control-sm text-center  text-bold" style="font-size: 7mm" value="{{ $encnotaentrega->nro_ent }}" maxlength="2" disabled/>
        </div>
...
<!-- Divisor Solicitud-->
    ...
    <div class="row col-12 offset-1">
        <div class="form-group col-4 ">
            ...
            <textarea  id="jus_sol" name="jus_sol"  class="form-control {{ $errors->has('jus_sol') ? 'is-invalid' : '' }}" rows="3" @if ( $valor!='iniciar') readonly @endif >{{ $encnotaentrega->jus_sol }}</textarea>
        </div>

        <div class="form-group col-4 ">
            <x-label for="observacion">Observación</x-label>
            <textarea  id="observacion" name="observacion"   class="form-control {{ $errors->has('observacion') ? 'is-invalid' : '' }}" rows="3" @if ($valor!='iniciar') readonly @endif>{{ $encnotaentrega->observacion }}</textarea>
...
<!-- Divisor Status -->
    ...
    <div class="row col-12  offset-1">
        ...
        <div class="form-group col-3">
            <x-label for="sta_ent">Entrega</x-label>
            <x-input class="form-control-sm text-center text-bold" style="font-size: 7mm" name="sta_ent" value="{{ $statusent }}" disabled/>
        ...
        <div class="form-group col-3">
            <x-label for="stat_causacion">Comprobante</x-label>
            <x-input class="form-control-sm text-center text-bold" style="font-size: 7mm" name="sta_ent" value="{{ $statcomprob }}" disabled/>
...
{{--
                <x-select name="stat_causacion" class="form-control-sm text-center " disabled>
                    <option value="">Seleccione...</option>
                    @foreach ($beneficiarios as $befeficiario)
                        <option value="{{ $befeficiario->rif_ben }}"
                            @selected(old('rif_ben', $befeficiario->value) == $encnotaentrega->rif_ben)> {{ $befeficiario->nom_ben }}
                        </option>
                    @endforeach
                </x-select>              --}}
            </div>
