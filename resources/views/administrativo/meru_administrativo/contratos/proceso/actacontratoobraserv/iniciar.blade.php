		...
		<div class="row mb-2">
			<div class="col-sm-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Iniciar Entrega</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
                <x-form method="get" action="{{ route('contratos.proceso.actacontratobraserv.iniciarentrega', $encnotaentrega->id) }}">
                    <x-card>
                        <x-slot name="header">
                        ...
                        <x-slot name="footer">
                            <x-input id="iniciar" name="iniciar" type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Iniciar entrega" />
                        </x-slot>
                    </x-card>
                </x-form>
			</div>
