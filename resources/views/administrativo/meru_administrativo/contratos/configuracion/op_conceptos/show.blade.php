		...
		<div class="row mb-2">
			<div class="col-sm-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Mostrar Conceptos de Contratos</li>
				</ol>
			</div>
		</div>
	</div>
                    ...
                    <x-slot name="body">
                        <div class="row col-12">
                            <x-field class="text-center col-1 offset-1">
                                ...
                                <x-input readonly  id="cod_con" name="cod_con"  value="{{ old('total', $conceptoscontrato->cod_con) }}"  class="text-center form-control-sm {{ $errors->has('cod_con') ? 'is-invalid' : '' }}" />
                            ...
                            <x-field class="text-center col-7">
                                ...
                                <x-input  readonly id="des_con" name="des_con"  value="{{ old('total', $conceptoscontrato->des_con) }}"  class="text-left form-control-sm {{ $errors->has('des_con') ? 'is-invalid' : '' }}" />
                                    <div class="invalid-feedback">
                            ...
                            <x-field class="text-center col-2 ">
                                ...
                                <x-select  readonly  style="pointer-events: none"  name="sta_reg" class="text-center  form-control-sm{{ $errors->has('status') ? 'is-invalid' : '' }}">
                                    <option value="{{ old('sta_reg', $conceptoscontrato->sta_reg) == '0' ? '0' : '1' }}" selected>{{ old('status', $conceptoscontrato->sta_reg) == '0' ? 'INACTIVO' : 'ACTIVO' }}</option>
                                                              </x-select>
                                <div class="invalid-feedback">
                        ...
                        <div class="row col-12">
                            <table class="table table-bordered table-sm text-center" >
                                ...
                                <tbody>
                                    @forelse ($conceptoscontrato->conceptoscontratodet as $item)
                                        <tr>
