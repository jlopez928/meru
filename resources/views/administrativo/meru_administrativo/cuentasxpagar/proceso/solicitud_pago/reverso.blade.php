        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active text-bold">Reverso Compromiso Certificación de Servicios</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <x-form method="get" action="{{ route('otrospagos.proceso.certificacionservicio.reverso_compromiso_certificacion', $opsolservicio->id) }}">
                    <div class="col-12">
                        <x-card>
                            <x-slot name="header">
