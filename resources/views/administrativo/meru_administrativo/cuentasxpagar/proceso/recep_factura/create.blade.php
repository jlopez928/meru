		...
		<div class="row sm-12">
			<div class="col-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Registrar Recepción de Factura</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
                <x-form method="post" action="{{ route('cuentasxpagar.proceso.recepfactura.store') }}">
                    <x-card>
                        <x-slot name="header">
                        ...
                        <x-slot name="body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane  active" id="recepcion" role="tabpanel" aria-labelledby="recepcion-tab">
                                    @include('administrativo/meru_administrativo/cuentasxpagar/proceso/recep_factura/partials/_recepcion')
                                </div>
                        ...
                        <x-slot name="footer">
                            <x-input id="guardar" name="guardar" type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Guardar" />
                        </x-slot>
                    </x-card>
                </x-form>
		</div>
