...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
                <x-form method="post" action="{{ route('cuentasxpagar.proceso.recepfactura.eliminar',$recepfactura->id) }}">
                    <x-card>
                        <x-slot name="header">
                        ...
                        <x-slot name="footer">
                            <x-input id="guardar" name="guardar" type="submit" class="btn btn-sm btn-primary text-bold float-right"  value="Eliminar" />
                        </x-slot>
                    </x-card>
                </x-form>
		</div>
