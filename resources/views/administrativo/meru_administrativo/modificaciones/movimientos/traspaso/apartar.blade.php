		...
		<div class="row mb-2">
			<div class="col-sm-12">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active text-bold">Apartar</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
                <x-form method="put" action="{{ route('modificaciones.movimientos.traspaso_presupuestario.apartar.update', $traspaso) }}">
                    <x-card>
                        <x-slot name="header">
                        ...
                        <x-slot name="footer">
                            <button type="submit" class="btn btn-sm btn-primary text-bold float-right">Apartar</button>
                        </x-slot>
                    </x-card>
                </x-form>
			</div>
