...
namespace App\Http\Requests\Administrativo\Meru_Administrativo\OtrosPagos\Configuracion;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;
use App\Models\Administrativo\Meru_Administrativo\OtrosPagos\OpConceptos;
use Illuminate\Support\Str;
class ConceptoServicioRequest extends FormRequest
{
    ...
    {
        return [
            'des_con'           => ['required',  Rule::unique('op_conceptos')->ignore($this->id)],
            'sta_reg'           => 'required',
    ...
    {
        $this->merge([
        'cod_con' =>OpConceptos::select('cod_con')->max('cod_con')+1,
