...
class FacturaIndex extends Component
{
    ...
    {
        return view('livewire.administrativo.meru-administrativo.cuentas-por-pagar.proceso.factura-index', [
            'headers' => [
                ...
                ['name' => 'N° Control',      'align' => 'center', 'sort' => 'num_ctrl'],
            ...
            'factura' => Factura::query()
                    ...
                    ->orWhere('num_ctrl', 'like', '%'.$this->search.'%')
