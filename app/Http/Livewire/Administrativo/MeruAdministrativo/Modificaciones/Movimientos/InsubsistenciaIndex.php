...
class InsubsistenciaIndex extends Component
{
    ...
    {
        return view('livewire.administrativo.meru-administrativo.modificaciones.movimientos.insubsistencia-index',[
            'headers' => [
            ...
            'insubsistencias' => Modificacion::query()
                ->where('tip_ope', TipoModificacion::Insubsistencia)
