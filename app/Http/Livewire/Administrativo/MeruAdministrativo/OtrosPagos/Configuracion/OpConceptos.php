...
class OpConceptos extends Component
{
    ...
    {
            if( $this->conceptoservicio->id){
                $this->cod_con=$this->conceptoservicio->cod_con;
                $this->des_con=$this->conceptoservicio->des_con;
                $this->sta_reg=$this->conceptoservicio->sta_reg;
                foreach($this->conceptoservicio->opconceptosdet as $key => $value) {
    ...
    {
        return view('livewire.administrativo.meru-administrativo.otros-pagos.configuracion.op-conceptos');
    }
}
