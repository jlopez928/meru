...
namespace App\Http\Livewire\Administrativo\MeruAdministrativo\Presupuesto\Causado;
...
class ActaContObraDesvIndex extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.administrativo.meru-administrativo.presupuesto.causado.acta-cont-obra-desv-index', [
            'headers' => [
